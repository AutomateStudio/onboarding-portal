  ...
  food: [
    {
      ...
      hero: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=300&q=80',
      ...
      products: [
        { img: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=200&q=80', name: 'Miel de Flores', price: '$38.000' },
        { img: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=200&q=80', name: 'Aceite de Oliva', price: '$52.000' },
        { img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=200&q=80', name: 'Pan Artesanal', price: '$28.000' },
        { img: 'https://images.unsplash.com/photo-1606914501449-5a96b6ce24ca?w=200&q=80', name: 'Mermelada', price: '$24.000' },
      ],
    },
    {
      id: 'levain',
      ...
      hero: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=300&q=80',
      ...
      products: [
        { img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=200&q=80', name: 'Sourdough', price: '$32.000' },
        { img: 'https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=200&q=80', name: 'Croissant Mantequilla', price: '$18.000' },
        { img: 'https://images.unsplash.com/photo-1568254183919-78a4f43a2877?w=200&q=80', name: 'Granola Orgánica', price: '$42.000' },
        { img: 'https://images.unsplash.com/photo-1484723091739-30a097e8f929?w=200&q=80', name: 'Tostadas Integrales', price: '$22.000' },
      ],
    },
    {
      id: 'mercado',
      ...
      hero: 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=300&q=80',
      ...
      products: [
        { img: 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=200&q=80', name: 'Canasta Verduras', price: '$65.000' },
        { img: 'https://images.unsplash.com/photo-1423483641154-5411ec9c0ddf?w=200&q=80', name: 'Canasta Frutas', price: '$55.000' },
        { img: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=200&q=80', name: 'Huevos de Campo', price: '$18.000' },
        { img: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=200&q=80', name: 'Lácteos Frescos', price: '$28.000' },
      ],
    },
  ],
  jewelry: [
    {
      ...
      hero: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=300&q=80',
      nav: { logo: 'LUMIÈRE', links: ['Colecciones', 'Anillos', 'Nosotros'], icons: ['♡', '🛒'] },
      eyebrow: 'JOYERÍA DE LUJO', title: 'Piezas que\nperduran.', cta: 'Explorar →',
      products: [
        { img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=200&q=80', name: 'Anillo Aurora', price: '$2,800,000' },
        { img: 'https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=200&q=80', name: 'Collar Eclipse', price: '$1,950,000' },
        { img: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=200&q=80', name: 'Aretes Sol', price: '$890,000' },
        { img: 'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=200&q=80', name: 'Pulsera Celeste', price: '$1,240,000' },
      ],
    },
    {
      id: 'diamante',
      ...
      hero: 'https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=300&q=80',
      ...
      products: [
        { img: 'https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=200&q=80', name: 'Solitario Blanco', price: '$4,500,000' },
        { img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=200&q=80', name: 'Trio de Anillos', price: '$2,100,000' },
        { img: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=200&q=80', name: 'Aretes Baguette', price: '$1,650,000' },
        { img: 'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=200&q=80', name: 'Collar Delicado', price: '$980,000' },
      ],
    },
    {
      id: 'heritage',
      ...
      hero: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=300&q=80',
      ...
      products: [
        { img: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=200&q=80', name: 'Anillo Herencia', price: '$1,480,000' },
        { img: 'https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=200&q=80', name: 'Broche Vintage', price: '$920,000' },
        { img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=200&q=80', name: 'Medallón Antiguo', price: '$1,200,000' },
        { img: 'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=200&q=80', name: 'Cadena Eslabón', price: '$760,000' },
      ],
    },
  ],
  electronics: [
  ...
  home: [
    {
      ...
      hero: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=300&q=80',
      nav: { logo: 'HAVEN', links: ['Sala', 'Comedor', 'Dormitorio'], icons: ['♡', '🛒'] },
      eyebrow: 'DISEÑO DE HOGAR', title: 'Espacios que\ninspiran.', cta: 'Explorar →',
      products: [
        { img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=200&q=80', name: 'Sofá Oslo', price: '$2,490,000' },
        { img: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=200&q=80', name: 'Mesa Roble', price: '$1,190,000' },
        { img: 'https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=200&q=80', name: 'Silla Terracota', price: '$480,000' },
        { img: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=200&q=80', name: 'Cojín Sage', price: '$95,000' },
      ],
    },
    {
      id: 'nordia',
      ...
      heroMobile: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=300&q=80',
      ...
      products: [
        { img: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=200&q=80', name: 'Silla Fjord', price: '$680,000' },
        { img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=200&q=80', name: 'Sofá Birch', price: '$3,100,000' },
        { img: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=200&q=80', name: 'Mesa Oak', price: '$1,450,000' },
        { img: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=200&q=80', name: 'Textil Lino', price: '$120,000' },
      ],
    },
    {
      id: 'loft',
      ...
      hero: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=300&q=80',
      nav: { logo: 'LOFT', links: ['Sala', 'Comedor', 'Oficina'], icons: ['♡', '🛒'] },
      eyebrow: 'DISEÑO INDUSTRIAL', title: 'Espacios que\nrespiran.', cta: 'Explorar →',
      products: [
        { img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=200&q=80', name: 'Sofá Brut 3P', price: '$2,890,000' },
        { img: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=200&q=80', name: 'Mesa Forge', price: '$1,450,000' },
        { img: 'https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=200&q=80', name: 'Silla Rivet', price: '$420,000' },
        { img: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=200&q=80', name: 'Estante Pipe', price: '$890,000' },
      ],
    },
  ],
  sports: [
    {
      ...
      hero: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=300&q=80',
      nav: { logo: 'APEX', links: ['Hombre', 'Mujer', 'Accesorios'], icons: ['♡', '🛒'] },
      eyebrow: 'ACTIVEWEAR', title: 'Tu límite\nes el cielo.', cta: 'Comprar →',
      products: [
        { img: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=200&q=80', name: 'Short Apex Pro', price: '$159,000' },
        { img: 'https://images.unsplash.com/photo-1506629082632-7a52f73dc01c?w=200&q=80', name: 'Sports Bra', price: '$119,000' },
        { img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=200&q=80', name: 'Tenis Apex X', price: '$349,000' },
        { img: 'https://images.unsplash.com/photo-1552763519-2d39c1db3575?w=200&q=80', name: 'Chaqueta Wind', price: '$289,000' },
      ],
    },
    {
      id: 'stride',
      ...
      hero: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&q=80',
      ...
      products: [
        { img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=200&q=80', name: 'Trail X Carbon', price: '$589,000' },
        { img: 'https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=200&q=80', name: 'Road Pro Elite', price: '$489,000' },
        { img: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=200&q=80', name: 'Short Stride 7"', price: '$129,000' },
        { img: 'https://images.unsplash.com/photo-1552763519-2d39c1db3575?w=200&q=80', name: 'Wind Jacket', price: '$249,000' },
      ],
    },
    {
      id: 'arena',
      ...
      heroMobile: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=300&q=80',
      nav: { logo: 'ARENA', links: ['Ropa', 'Calzado', 'Equipos'], icons: ['♡', '🛒'] },
      eyebrow: 'GYM PERFORMANCE', title: 'No hay\nlímites.', cta: 'Comprar ahora →',
      products: [
        { img: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=200&q=80', name: 'Dry-Fit Pro Tee', price: '$89,900' },
        { img: 'https://images.unsplash.com/photo-1562183241-b937e95585b6?w=200&q=80', name: 'Power Short 7"', price: '$119,900' },
        { img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=200&q=80', name: 'ZeroG Trainer', price: '$289,900' },
        { img: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=200&q=80', name: 'KB Elite 24kg', price: '$189,900' },
      ],
    },
  ],
  general: [
    {
      ...
      hero: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=300&q=80',
      nav: { logo: 'BAZAAR', links: ['Tienda', 'Categorías', 'Ofertas'], icons: ['🔍', '🛒'] },
      eyebrow: 'TIENDA GENERAL', title: 'Todo lo que\nnecesitas.', cta: 'Explorar →',
      products: [
        { img: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=200&q=80', name: 'Producto Top 1', price: '$89,000' },
        { img: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200&q=80', name: 'Producto Top 2', price: '$145,000' },
        { img: 'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=200&q=80', name: 'Producto Top 3', price: '$67,000' },
        { img: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200&q=80', name: 'Producto Top 4', price: '$199,000' },
      ],
    },
    {
      id: 'urban',
      ...
      hero: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=600&q=80',
      heroMobile: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=300&q=80',
      nav: { logo: 'URBAN', links: ['Hombre', 'Mujer', 'Accesorios'], icons: ['♡', '🛒'] },
      eyebrow: 'URBAN LIFESTYLE', title: 'Define tu\nestilo.', cta: 'Ver drop →',
      products: [
        { img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=200&q=80', name: 'Oversized Core Tee', price: '$79,900' },
        { img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=200&q=80', name: 'Urban Air Sneaker', price: '$239,900' },
        { img: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=200&q=80', name: 'Tech Jacket V2', price: '$349,900' },
        { img: 'https://images.unsplash.com/photo-1511405889574-b28a8e844b01?w=200&q=80', name: 'Cap Urban Logo', price: '$49,900' },
      ],
    },
    {
      id: 'vida',
      ...
      heroMobile: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=300&q=80',
      nav: { logo: 'vida', links: ['Hogar', 'Moda', 'Bienestar'], icons: ['♡', '🛒'] },
      eyebrow: 'LIFESTYLE LATINO', title: 'El sabor de\nvivir bien.', cta: 'Explorar →',
      products: [
        { img: 'https://images.unsplash.com/photo-1578500494198-246f612d3b3d?w=200&q=80', name: 'Canasta artesanal', price: '$129,000' },
        { img: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=200&q=80', name: 'Blusa Siesta', price: '$89,000' },
        { img: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=200&q=80', name: 'Kit Bienestar', price: '$159,000' },
        { img: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&q=80', name: 'Set Cocina Latina', price: '$219,000' },
      ],
    },
  ],
  fashion: [
